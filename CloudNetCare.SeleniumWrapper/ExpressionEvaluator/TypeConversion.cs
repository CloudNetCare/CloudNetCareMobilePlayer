...
namespace CloudNetCare.SeleniumWrapper.ExpressionEvaluator
{
    ...
    {
        private readonly IReadOnlyDictionary<Type, int> _typePrecedence;
        ...
        {
            if (!Instance._typePrecedence.ContainsKey(le.Type) ||
                !Instance._typePrecedence.ContainsKey(re.Type)) return;
        ...
        {
            if (!Instance._typePrecedence.ContainsKey(le.Type) ||
                !Instance._typePrecedence.ContainsKey(type)) return le;
